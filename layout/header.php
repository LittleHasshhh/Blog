<header class="bg-dark py-4">
            <div class="container">
                ...
                <div class="row">
                        ...
                        <nav>
                            <ul class="d-flex align-items-center justify-content-center gap-5 py-3">
                                ...
                                <?php if (isset($_SESSION['user'])): ?>
                                    <li><a href="logout.php" title="deconnexion" class="text-secondary text-decoration-none">deconnexion</a></li>
                                <?php else: ?>
                                    <li><a href="login.php" title="connexion" class="text-secondary text-decoration-none">connexion</a></li>
                                <?php endif;?>
                                
                                <li><a href="#" title="Styles" class="text-secondary text-decoration-none">contact</a></li>
                    ...
                    <!-- affiche le caroussel seulement sur la page acceuil -->
